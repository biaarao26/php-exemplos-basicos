...
// Exemplo de URL: https://localhost/php-basico-out-2024/2_opera_variaveis.php?numero1=10numero2=5
...
if (isset($numero1) && isset($numero2)) {
    ...
    echo "Por favor, foneça os valores de numero1 e numero2 pela URL"
}
?>